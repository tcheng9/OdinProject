...
function onSubmit(){
    ...
    // let formBook = new bookMaker(formAuthor, formTitle, formPages, formReadStatus);

    // addBook(formBook);
    
    // // console.log(addBook);
    // let cell  = document.createElement('td');
    // let textNode = document.createTextNode(formAuthor);
    // let row = document.createElement('tr');
    ...
    var display = document.getElementById("libraryTable");
